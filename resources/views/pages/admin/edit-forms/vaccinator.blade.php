        ...
        <div class="col-md-8 offset-md-2">
            <div class="border border-gray pt-2 pb-3 pl-5 pr-5 mt-3 text-center rounded shadow-sm bg-white">
                <div class="d-flex justify-content-center mt-2">
                    ...
                    <h4 class="text-primary text-content-heading ml-2 mt-1"> Edit Vaccinator</h4>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="border border-gray pt-3 pb-4 pl-5 pr-5 mt-2 rounded shadow-sm bg-white">
                ...
                <form action="{{ route('vaccinator.update',$vaccinator) }}" method="post" class="mt-2">
                    @csrf
                    @method("PATCH")
                    <div class="row">
                        <div class="col-md-6 pr-md-1">
                            <label class="text-secondary">First name <small class="text-danger">(required)</small></label>
                            <input type="text" class="form-control mb-1" name="firstname" value="{{ old('firstname') ?? $vaccinator->firstname }}" required>
                            @error('firstname')
                        ...
                        <div class="col-md-6 pl-md-1">
                            ...
                            <input type="text" class="form-control mb-1" name="lastname" value="{{ old('lastname') ?? $vaccinator->lastname }}" required>
                            @error('lastname')
                            <small class="text-danger" style="font-size: 12px !important;">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 pr-md-1">
                            ...
                            <input type="text" class="form-control mb-1" name="middlename" value="{{ old('middlename') ?? $vaccinator->middlename }}">
                        </div>
                        <div class="col-md-6 pl-md-1">
                            <label class="text-secondary">Suffix <small class="text-gray">(optional)</small></label>
                            <input type="text" class="form-control mb-1" name="suffix" value="{{ old('suffix')  ?? $vaccinator->suffix}}">
                        </div>
                    </div>
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6 pr-md-1">
                            ...
                            <input type="text" name="position" class="form-control mb-1" value="{{ old('position')  ?? $vaccinator->position}}" required>
                            @error('position')
                            <small class="text-danger" style="font-size: 12px !important;">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="col-md-6 pl-md-1">
                            ...
                            <input type="text" class="form-control mb-1" name="role" value="{{ old('role') ?? $vaccinator->role }}" required>
                            @error('role')
                            <small class="text-danger" style="font-size: 12px !important;">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 pr-md-1">
                            ...
                            <select name="facility_id" class="form-control mb-1" required>
                                ...
                                @forelse ($facilities as $facility)
                                    <option value="{{ $facility->id }}" @if($vaccinator->facility->id===$facility->id) selected @endif>{{ $facility->facility_name }}</option>
                                @empty
                        ...
                        <div class="col-md-6 pl-md-1">
                            ...
                            <input type="text" class="form-control mb-1" name="prc" value="{{ old('prc') ?? $vaccinator->role }}" required>
                            @error('prc')
                            <small class="text-danger" style="font-size: 12px !important;">{{ $message }}</small>
                            @enderror
                        </div>
