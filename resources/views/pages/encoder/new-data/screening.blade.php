<div class="row mt-1">
    ...
    <div class="col-md-12 pl-md-5 pl-sm-3">
        <div class="d-flex justify-content-start">
            <input type="checkbox" class="mt-2 mr-2" id="toggle" name="age_more_than_16_years_old" style="padding-right: 35px;">
    ...
    <div class="col-md-12 mt-2 pl-md-5 pl-sm-3">
        <div class="d-flex justify-content-start">
            <input type="checkbox" class="mt-2 mr-2" id="toggle" name="has_no_severe_allergic_reaction" style="padding-right: 35px;">
    ...
    <div class="col-md-12 mt-2 pl-md-5 pl-sm-3">
        <div class="d-flex justify-content-start">
            <input type="checkbox" class="mt-2 mr-2" id="toggle" name="has_no_allergy_to_food" style="padding-right: 35px;">
        ...
        <div class="d-flex justify-content-start ml-4">
            <input type="checkbox" class="mt-2 mr-2" id="toggle" name="if_with_allergy_or_asthma" style="padding-right: 35px;">
    ...
    <div class="col-md-12 mt-2 pl-md-5 pl-sm-3">
        <div class="d-flex justify-content-start">
            <input type="checkbox" class="mt-2 mr-2" id="toggle" name="has_no_history" style="padding-right: 35px;">
            <p class="ml-3 mt-1 pt-1 text-secondary">Has no history of bleeding disorders or currently taking anti-coagulants?</p>
        </div>
        <div class="d-flex justify-content-start ml-4">
            <input type="checkbox" class="mt-2 mr-2" id="toggle" name="if_with_bleeding_history" style="padding-right: 35px;">
    ...
    <div class="col-md-12 mt-2 pl-md-5 pl-sm-3">
        <div class="d-flex justify-content-start">
            <input type="checkbox" class="mt-2 mr-2" id="toggle" name="does_not_manifest_any_of_the_following_symptoms" style="padding-right: 35px;">
        ...
        <div class="d-flex justify-content-start ml-2 pl-2">
            ...
            <div>
                ...
                <div class="d-flex justify-content-start ml-3">
                    <input type="checkbox" class="mt-2 mr-2" id="toggle" name="if_manifesting_any_of_the_mentioned_symptoms[]" value="Headache">
                    <p class="ml-3 mt-1 pt-1 text-secondary">Headache</p>
                </div>
                <div class="d-flex justify-content-start ml-3">
                    <input type="checkbox" class="mt-2 mr-2" id="toggle" name="if_manifesting_any_of_the_mentioned_symptoms[]" value="Cough">
                    <p class="ml-3 mt-1 pt-1 text-secondary">Cough</p>
                </div>
                <div class="d-flex justify-content-start ml-3">
                    <input type="checkbox" class="mt-2 mr-2" id="toggle" name="if_manifesting_any_of_the_mentioned_symptoms[]" value="Colds">
                    <p class="ml-3 mt-1 pt-1 text-secondary">Colds</p>
                </div>
                <div class="d-flex justify-content-start ml-3">
                    <input type="checkbox" class="mt-2 mr-2" id="toggle" name="if_manifesting_any_of_the_mentioned_symptoms[]" value="Soar Throat">
                    <p class="ml-3 mt-1 pt-1 text-secondary">Soar Throat</p>
                </div>
                <div class="d-flex justify-content-start ml-3">
                    <input type="checkbox" class="mt-2 mr-2" id="toggle" name="if_manifesting_any_of_the_mentioned_symptoms[]" value="Myalga">
                    <p class="ml-3 mt-1 pt-1 text-secondary">Myalga</p>
                </div>
                <div class="d-flex justify-content-start ml-3">
                    <input type="checkbox" class="mt-2 mr-2" id="toggle" name="if_manifesting_any_of_the_mentioned_symptoms[]" value="Fatigue">
                    <p class="ml-3 mt-1 pt-1 text-secondary">Fatigue</p>
                </div>
                <div class="d-flex justify-content-start ml-3">
                    <input type="checkbox" class="mt-2 mr-2" id="toggle" name="if_manifesting_any_of_the_mentioned_symptoms[]" value="Weakness">
                    <p class="ml-3 mt-1 pt-1 text-secondary">Weakness</p>
                </div>
                <div class="d-flex justify-content-start ml-3">
                    <input type="checkbox" class="mt-2 mr-2" id="toggle" name="if_manifesting_any_of_the_mentioned_symptoms[]" value="Loss of smell/taste">
                    <p class="ml-3 mt-1 pt-1 text-secondary">Loss of smell/taste</p>
                </div>
                <div class="d-flex justify-content-start ml-3">
                    <input type="checkbox" class="mt-2 mr-2" id="toggle" name="if_manifesting_any_of_the_mentioned_symptoms[]" value="Diarrhea">
                    <p class="ml-3 mt-1 pt-1 text-secondary">Diarrhea</p>
                </div>
                <div class="d-flex justify-content-start ml-3">
                    <input type="checkbox" class="mt-2 mr-2" id="toggle" name="if_manifesting_any_of_the_mentioned_symptoms[]" value="Shortness of breath/difficulty in breathing">
    ...
    <div class="col-md-12 mt-2 pl-md-5 pl-sm-3">
        <div class="d-flex justify-content-start">
            <input type="checkbox" class="mt-2 mr-2" id="toggle" name="has_no_history_of_exposure">
    ...
    <div class="col-md-12 mt-2 pl-md-5 pl-sm-3">
        <div class="d-flex justify-content-start">
            <input type="checkbox" class="mt-2 mr-2" id="toggle" name="has_not_been_previously_treated_for_covid_19">
    ...
    <div class="col-md-12 mt-2 pl-md-5 pl-sm-3">
        <div class="d-flex justify-content-start">
            <input type="checkbox" class="mt-2 mr-2" id="toggle" name="has_not_received_any_vaccine_in_the_past_2_weeks">
    ...
    <div class="col-md-12 mt-2 pl-md-5 pl-sm-3">
        <div class="d-flex justify-content-start">
            <input type="checkbox" class="mt-2 mr-2" id="toggle" name="has_not_received_convalescent">
    ...
    <div class="col-md-12 mt-2 pl-md-5 pl-sm-3">
        <div class="d-flex justify-content-start">
            <input type="checkbox" class="mt-2 mr-2" id="toggle" name="does_not_have_any_of_the_following" style="padding-right: 35px;">
        ...
        <div class="d-flex justify-content-start ml-3">
            ...
            <div>
                ...
                <div class="d-flex justify-content-start ml-3">
                    <input type="checkbox" class="mt-2 mr-2" id="toggle" name="if_with_mentioned_conditions_specify[]" value="Cancer/Malignancy">
                    <p class="ml-3 mt-1 pt-1 text-secondary">Cancer/Malignancy</p>
                </div>
                <div class="d-flex justify-content-start ml-3">
                    <input type="checkbox" class="mt-2 mr-2" id="toggle" name="if_with_mentioned_conditions_specify[]" value="Underwent Transplant">
                    <p class="ml-3 mt-1 pt-1 text-secondary">Underwent Transplant</p>
                </div>
                <div class="d-flex justify-content-start ml-3">
                    <input type="checkbox" class="mt-2 mr-2" id="toggle" name="if_with_mentioned_conditions_specify[]" value="Under Steriod Medication/Treatment">
                    <p class="ml-3 mt-1 pt-1 text-secondary">Under Steriod Medication/Treatment</p>
                </div>
                <div class="d-flex justify-content-start ml-3">
                    <input type="checkbox" class="mt-2 mr-2" id="toggle" name="if_with_mentioned_conditions_specify[]" value="Bed Ridden">
                    <p class="ml-3 mt-1 pt-1 text-secondary">Bed Ridden</p>
                </div>
                <div class="d-flex justify-content-start ml-3">
                    <input type="checkbox" class="mt-2 mr-2" id="toggle" name="if_with_mentioned_conditions_specify[]" value="Terminal Illness">
                    <p class="ml-3 mt-1 pt-1 text-secondary">Terminal illness</p>
                </div>
                <div class="d-flex justify-content-start ml-3">
                    <input type="checkbox" class="mt-2 mr-2" id="toggle" name="if_with_mentioned_conditions_specify[]" value="Less 6 months prognosis">
